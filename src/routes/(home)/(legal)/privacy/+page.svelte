	...
	<div class="flex w-full max-w-[1000px] flex-col gap-4 rounded-lg border bg-white p-4 text-black">
		<span>
			<i>
				...
				The following contains information about the collection and use of personal data when using
				our website.
			</i>
			<br />
			<br />
			<i>
				...
				"RECOMMENDED", "MAY" and "OPTIONAL" in this document are to be interpreted as described in <a
		...
		<h4>Cookies</h4>
		<span>
			For the use of our website and services cookies must be enabled. Cookies are small text files,
			located on your local hard drive, containing information about your account and settings (e.g.
			Location, Language, Styletheme). Cookies help us to provide personal services. <i>
				Cookies contain no personally identifiable data
			</i>
			.
		</span>
		<h4>External Links</h4>
		<span>
			Some links on this site redirect to external sites where we have no control on the content and
			security. These sites may collect their own data, use their own cookies and even store
			personal data. Some links redirect to sites which may be harmfull, or as old, that they don't
			even exist anymore. Since the permanent control of contents of these external links is
			impossible, we assume no responsibility for the content of websites that are beyond our
			control. If you discover a site with malicious content, you can report them by sending an
			email to
			<a href="mailto:priceactiontalk25@gmail.com">priceactiontalk25@gmail.com</a>
			and we will check its maleficence and remove all links, forwarding to this site.
		</span>
		<h4>Changes to the Privacy Policies</h4>
		<span>
			By browsing on our site and using our services you automatically accept the privacy policies
			and terms and conditions. These may change from time to time. If major changes should occur to
			the Privacy Policy, we will inform you in time. Two weeks after the promulgation of changes,
			these will be valid, so you have enough time to read them and accept. Within these two
			calendar weeks (14 calendar days), the older provisions are valid.
		</span>
		<h4>Unanswered Questions?</h4>
		<span>
			Feel free to contact us and ask if there are any ambiguities. We'll answer any questions sent
			to
			<a href="mailto:priceactiontalk25@gmail.com">priceactiontalk25@gmail.com</a>
			.
		</span>
		<div id="date_of_validity">- Friday, 20th June 2025</div>
		<br />
		<br />
